...
void send_io_dialfs_write(int fd_io, uint16_t pid, int direccion, int tamanio, int puntero_archivo);
void send_io_dialfs_read(int fd_io, uint16_t pid, int direccion, int tamanio, int puntero_archivo);
#endif
